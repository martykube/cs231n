...
class KNearestNeighbor(object):
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      #########################################################################
      indexes = np.argpartition(dists[i], k)
...
if __name__ == '__main__':
  # test = np.array([[2,2],[3,3]])
  # print test
  # train = np.array([[1, 1], [-1, -1], [2, 1]])
  # print train

  # classifier = KNearestNeighbor()
  # classifier.train(train, np.array([]))

  # dist = classifier.compute_distances_two_loops(test)
  # print dist

  y = np.array([0, 1, 0, 1, 0, 1])
  print y
  dist = np.array([12, 5, 7, 4, 2, 6])
  print dist
  
  k = 1
  print 'k', k

  part = np.partition(dist, 2)
  print 'part', part

  # print 'dist', dist[part]
